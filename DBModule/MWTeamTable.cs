...
{
    class MWTeamTable : GenericTable, IDBTable
    {
        public static string _TableName { get; set; } = "teams";
        public MWTeamTable(MWDBModule module)
        {
            Module = module;
            TableName = _TableName;
            Schema = new MWTeamSchema();
        }
            ...
            try
            {
                ...
                using (SQLiteConnection connection = new SQLiteConnection(Module.ConnectionString))
                {
                    ...
                    using (SQLiteCommand command = new SQLiteCommand(connection))
                    {
                        ...
                        command.Parameters.AddRange(Schema.GetParameters(team).ToArray());
